dsteam Update welcome.lua
1 contributor
RawBlameHistory    105 lines (98 sloc)  3.59 KB
...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "❤سلام جیگر💙 .  "..nama.."\nخوشومدی به  '"..string.gsub(msg.to.print_name, "_", " ").."'\nاز قوانین و حرف پیروی کن و به افراد گروه احترام بزار😊 .برای دیدن قوانین rules و برای دیدن درباره گروه about \n"
